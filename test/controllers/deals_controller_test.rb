...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { amount: @deal.amount, portfolio_id: @deal.portfolio_id, stock_id: @deal.stock_id } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { amount: @deal.amount, portfolio_id: @deal.portfolio_id, stock_id: @deal.stock_id } }
